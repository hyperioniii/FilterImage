package com.example.linhnh.view;
...
import com.example.linhnh.view.R;
import com.nineoldandroids.view.ViewHelper;
/**
 * Created by LinhNguyen on 11/11/2015.
 */
public class ProgessSlideIndicator  extends CustomView {
    ...
    public ProgessSlideIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttributes(attrs);
    }
